...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { comentario: @rating.comentario, nota: @rating.nota } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { comentario: @rating.comentario, nota: @rating.nota } }
